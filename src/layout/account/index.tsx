...
function Account() {
    ...
    const roleUser = profile ? profile.role_name : false
    return (
        <Tabs defaultValue="general">
            ...
            <TabsContent className='my-5 md:my-10 p-2.5 md:p-5 rounded-lg shadow-md shadow-accent border border-accent' value={'general'}>
                <General />
            </TabsContent>
            <TabsContent className='my-5 md:my-10 p-2.5 md:p-5 rounded-lg shadow-md shadow-accent border border-accent' value={'password'}>
                <ChangePassword />
            </TabsContent>
        </Tabs>
    )
